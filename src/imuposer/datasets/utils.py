...
def get_dataset(config=None, test_only=False):
    ...
    if model in ("GlobalModelIMUPoser", "ReconIMUPoser", "StagedIMUPoser", "TransformerIMUPoser", "DiffusionIMUPoser"):
...
def get_datamodule(config):
    model = config.model
    # load the dataset
    if model in ["GlobalModelIMUPoser", "GlobalModelIMUPoserFineTuneDIP", "ReconIMUPoser", "StagedIMUPoser", "TransformerIMUPoser", "DiffusionIMUPoser"]:
